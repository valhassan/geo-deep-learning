...
python $INFERENCE_SCRIPT \
    --checkpoint /export/sata01/wspace/test_dir/multi/all_rgb_data/dynamic2_segformer.ckpt \
    ...
    --output /home/valhassa/Projects/geo-deep-learning/experiments/data/out/ns2_wv2_dynamic2_segformer_rgbn_clahe25.tif \
