...
python $INFERENCE_SCRIPT \
    --checkpoint /export/sata01/wspace/test_dir/multi/demo/pt2/dofav2_67_0.418.pt2 \
    --input /export/sata01/wspace/test_dir/multi/demo/image/ns2_small_rgbn.tif \
    --output /export/sata01/wspace/test_dir/multi/demo/prediction/ns2_small_rgbn_67_0.418_no_tta.tif \
